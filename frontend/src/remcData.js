...
export const profileData = {
  ...
  occupationsByAge: {
    lycee: [
      "Lycéen(ne) en Seconde",
      "Lycéen(ne) en Première",
      "Lycéen(ne) en Terminale",
      "Lycéen(ne) en Bac Pro Commerce",
      "Lycéen(ne) en Bac Pro Mécanique",
      "Lycéen(ne) en Bac Pro Électricité",
    ...
    licence: [
      ...
      "Étudiant(e) en L2 Psychologie",
      "Étudiant(e) en L3 Économie-Gestion",
      "Étudiant(e) en L1 STAPS",
      "Étudiant(e) en L2 Lettres Modernes",
      "Étudiant(e) en L3 Informatique",
      "Étudiant(e) en L1 Biologie",
      "Étudiant(e) en BTS Comptabilité",
      "Étudiant(e) en BTS Commerce International",
      "Étudiant(e) en DUT Techniques de Commercialisation",
      "Étudiant(e) en école d'infirmier(ère)",
      "Apprenti(e) en alternance BTS",
      "Aide-soignant(e)",
      "Vendeur(se) en prêt-à-porter",
    ...
    master: [
      ...
      "Étudiant(e) en M2 Marketing Digital",
      "Étudiant(e) en M1 Informatique",
      "Étudiant(e) en M2 Ressources Humaines",
      "Étudiant(e) en école d'ingénieur",
      "Étudiant(e) en école de commerce",
      "Étudiant(e) en M1 Psychologie Clinique",
    ...
    doctorat: [
      ...
      "Doctorant(e) en Lettres",
      "Doctorant(e) en Droit",
